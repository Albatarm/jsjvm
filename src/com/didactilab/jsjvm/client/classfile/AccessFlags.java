...
public interface AccessFlags {
	...
	int ACC_INNERCLASS = ACC_PUBLIC | ACC_PRIVATE | ACC_PROTECTED | ACC_STATIC | 
			ACC_FINAL | ACC_INTERFACE | ACC_ABSTRACT | ACC_SYNTHETIC | 
			ACC_ANNOTATION | ACC_ENUM;
	int ACC_PARAMETER = ACC_FINAL | ACC_SYNTHETIC | ACC_MANDATED;
